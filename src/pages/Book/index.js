                ...
                <ScrollView>
                    <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                        ...
                        <View style={[styles.informationCard]}>
                            ...
                            <Text style={[styles.informationTextLeft, { marginTop: height * 0.02 }]}>
                                INFORMAÇÕES
                            </Text>
                            ...
                            <View style={styles.row}>
                                ...
                                <Text style={[styles.informationTextRight]}>
                                    {route.params.object.publisher}</Text>
                            </View>
                            <View style={styles.row}>
                                <Text style={[styles.informationTextLeft]}>
                                    Publicação
                                ...
                                <Text style={[styles.informationTextRight]}>
                                    {route.params.object.published}</Text>
                            </View>
                            <View style={styles.row}>
                                <Text style={[styles.informationTextLeft]}>
                                    Idioma
                                ...
                                <Text style={[styles.informationTextRight]}>
                                    {route.params.object.language}</Text>
                            </View>
                            <View style={styles.row}>
                                <Text style={[styles.informationTextLeft]}>
                                    Título Original
                                ...
                                <Text style={[styles.informationTextRight]}>
                                    {route.params.object.title}</Text>
                            </View>
                            <View style={styles.row}>
                                <Text style={[styles.informationTextLeft]}>
                                    ISBN-10
                                ...
                                <Text style={[styles.informationTextRight]}>
                                    {route.params.object.isbn10}</Text>
                            </View>
                            <View style={styles.row}>
                                <Text style={[styles.informationTextLeft]}>
                                    ISBN-13
                                ...
                                <Text style={[styles.informationTextRight]}>
                                    {route.params.object.isbn13}</Text>
                            </View>
                            <View style={styles.row}>
                                <Text style={[styles.informationTextLeft]}>
                                    Categoria
                                ...
                                <Text style={[styles.informationTextRight]}>
                                    {route.params.object.category}</Text>
                            </View>
                        </View>
